...
require "carou.php" ;
    ...
    $bouton3 = [
        "titre"=>"religion",
        "contenu"=>"reliblablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablab"
    ];
$boutons = [$bouton0, $bouton1, $bouton2, $bouton3];
