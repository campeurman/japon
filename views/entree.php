...
// var_dump($html);
// $recetteHtml = "";
//     $recetteHtml .= "<img src=\"".recette[image]."\"><div class=\"description\"><h2>". recette[titre]."</h2><p>".recette[description]."</p><table><tr><th>Personnes</th><th>Temps</th><th>Difficulté</th><th>Coût</th></tr><tr><td>". recette[personnes]."</td><td>".recette[temps]."</td><td>". recette[difficulte]."</td><td>". recette[cout]."</td></tr></table></div><div class='contenu'><div class='ul'><h2>Ingrédients</h2>".formatLst(recettes[index].ingredients."</div><div class='ol'><h2>Etapes</h2>".formatLst(recette[etapes])."</div></div>";
//     var_dump($recetteHtml);
