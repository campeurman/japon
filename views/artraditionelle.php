...
require "carou.php" ;
$text='<div id="idtext"><h1>hfdrtjhnbqsnytyuju</h1><p>tradkkkkkkkkkkkkkkfhuuuuuuuuuuuuuuuuuiii iiiiiiiiiiiiytrrrrrrrrrrrbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbtdhgf hvtfhbvhft vtr hg</p></div>';
echo $text;
